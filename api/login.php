...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows == 1) {
        ...
        if ($password === $row['password']) { // Perhatikan: ini tidak aman untuk produksi
...
<head>
    ...
    <title>Login e-Artikel Winni Code</title>
                    ...
                    <div class="card-body">
                        <div class="app-brand justify-content-center">
                            ...
                            <img src="assets/admin/assets/img/favicon/logo.ico" alt="Logo" style="height: 40px;"/>
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Winni Code</span>
                            </a>
                        </div>
                        <h4 class="mb-2">Selamat datang di e-Artikel Winni Code! 👋</h4>
                        <p class="mb-4"></p>
                        <?php if (isset($error)) : ?>
