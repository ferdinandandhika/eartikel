...
<head>
    ...
    <title>Admin e-Artikel Winni Code</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="/assets/admin/assets/img/favicon/logo.ico" />
    ...
    <style>
        .menu-inner > .menu-item {
            margin-bottom: 0.25rem !important; /* Mengurangi jarak vertikal antar menu item */
        }
        .menu-inner > .menu-item > .menu-link {
            padding-top: 0.5rem !important; /* Mengurangi padding atas */
            padding-bottom: 0.5rem !important; /* Mengurangi padding bawah */
        }
    </style>
</head>
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.php" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <img src="/assets/admin/assets/img/favicon/logo.ico" alt="Logo" style="height: 40px;"/>
                        </span>
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">Winni Code</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Tambah Artikel -->
                    <li class="menu-item">
                        <a href="tambah_artikel.php" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-plus-circle"></i>
                            <div data-i18n="Analytics">Tambah Artikel</div>
                        </a>
                    </li>

                    <!-- Draft Artikel -->
                    <li class="menu-item">
                        <a href="draft_artikel.php" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-file"></i>
                            <div data-i18n="Analytics">Draft Artikel</div>
                        </a>
                    </li>
                </ul>
            </aside>
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <div class="navbar-nav align-items-center">
                            <div class="nav-item d-flex align-items-center">
                                Halaman Admin Artikel Winni Code <a href="../index.php" target="_blank" class="ms-3 btn btn-sm btn-icon btn-outline-primary">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <div class="avatar avatar-online">
                                        <img src="/assets/admin/assets/img/avatars/ferdi.jpg" alt class="w-px-40 h-auto rounded-circle" />
                                    </div>
                                </a>
