...
*/ -->
    ...
    <head>
        ...
        <link rel="shortcut icon" href="assets/landing/logo.png">
        ...
        <title>E-Artikel | Winni Code</title>
    </head>
                ...
                <div class="menu-bg-wrap">
                    <div class="site-navigation">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                                <a href="index.php" class="logo m-0 float-start">Winni Code<span class="text-primary">.</span></a>
                            </div>
